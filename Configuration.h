 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 26.0, -36.0, -2.63 }
...
#define ENABLE_LEVELING_AFTER_G28 // Always want the bed levelling enabled
...
#define HOMING_FEEDRATE_MM_M { (150*60), (150*60), (30*60) }
