...
//#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  #define FAST_PWM_FAN_FREQUENCY  // Define here to override the defaults below
...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  47.0        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.15       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  47.0        // (Hz) The default dominant resonant frequency on the Y axis.
  ...
  #define SHAPING_MAX_STEPRATE 20000  // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
...
#define LIN_ADVANCE
  ...
  #define EXPERIMENTAL_SCURV      // Allow S-Curve Acceleration to be used with LA.
